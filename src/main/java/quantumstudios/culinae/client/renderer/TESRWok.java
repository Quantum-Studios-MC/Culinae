...
import quantumstudios.culinae.client.CulinaryRenderHelper;
import quantumstudios.culinae.fluids.CulinaeFluids;
import quantumstudios.culinae.tiles.TileWok;
import quantumstudios.culinae.tiles.TileWok.SeasoningInfo;
...
public class TESRWok extends TESRFirePit<TileWok>
{
    ...
    public void render(TileWok tile, double x, double y, double z, float partialTicks, int destroyStage, float alpha)
    {
        ...
        if (seasoningInfo != null && seasoningInfo.volume > 0)
        {
            ...
            int brightness = mc.world.getCombinedLight(tile.getPos(), CulinaeFluids.JUICE.getLuminosity());
