...
public final class ChoppingBoardModel implements IModel
{
    public static final class Loader implements ICustomModelLoader
    {
        ...
        {
            return culinae.MODID.equals(location.getNamespace()) && "models/block/chopping_board_special".equals(location.getPath());
        }
    ...
    static
    {
        ...
        updateSpecialItemList(CulinaeConfig.CLIENT.useBlockModelForChoppingBoardFirst);
        /*
