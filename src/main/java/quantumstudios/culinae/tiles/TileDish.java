...
public class TileDish extends TileBase
{
    ...
    {
        return this.dishContainer.isEmpty() ? new ItemStack(CulinaeRegistry.PLACED_DISH) : this.dishContainer.copy();
    }
    ...
    public void readFromNBT(NBTTagCompound compound)
    {
        ...
        // this is a serialized quantumstudios.culinae.internal.food.Dish object.
