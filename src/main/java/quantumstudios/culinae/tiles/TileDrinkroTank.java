...
public class TileDrinkroTank extends TileBase implements CookingVessel
{
    ...
    {
        super();
        if (CulinaeConfig.GENERAL.drinkroUsesFE > 0)
        {
            battery = new Battery(CulinaeConfig.GENERAL.drinkroUsesFE * 50, CulinaeConfig.GENERAL.drinkroUsesFE, 0);
        }
        else
        {
            battery = null;
    ...
    public void neighborChanged(IBlockState state)
    {
        ...
        if (poweredIn && !this.powered && !isWorking())
        {
            ...
            if (battery == null || battery.getEnergyStored() >= CulinaeConfig.GENERAL.drinkroUsesFE)
            {
                working = true;
    ...
    public void stopProcess()
    {
        ...
        ItemStack itemDrink = new ItemStack(CulinaeRegistry.DRINK);
        ...
        if (battery != null)
        {
            battery.setEnergy(battery.getEnergyStored() - CulinaeConfig.GENERAL.drinkroUsesFE);
        }
    ...
    {
        if (oldState.getBlock() != CulinaeRegistry.DRINKRO || newState.getBlock() != CulinaeRegistry.DRINKRO)
        {
            return true;
        }
        else
