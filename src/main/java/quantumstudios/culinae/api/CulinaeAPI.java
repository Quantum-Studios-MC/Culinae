...
/**
 * Main interface that one can use to interact with Culinae's internal.
 *
 ...
 * functionality to determine if Culinae internals knows that a given {@link
 * ItemStack} or {@link FluidStack} instance is mapped to a certain
 * {@link Material} or {@link Spice}.
 * <p>
 * An instance of {@code CulinaeAPI} is accessible, and will be available
 * after FML Pre-Initialization stage, at {@link CulinaryHub#API_INSTANCE}.
 * </p>
 */
public interface CulinaeAPI
{

    // Registration method

    /**
     * Register a {@link Material} into Culinae, so that Culinae will recognize it.
    ...
    /**
     * Register a {@link Spice} into Culinae, so that Culinae will recognize it.
     * The registration process follows "first come, first serve" basis; that said,
    ...
    /**
     * Register a {@link Effect} into Culinae, so that Culinae will recognize it.
     * The registration process follows "first come, first serve" basis; that said,
    ...
    /**
     * Register a {@link Recipe} into Culinae, so that Culinae will recognize it.
     * The registration process follows "first come, first serve" basis; that said,
