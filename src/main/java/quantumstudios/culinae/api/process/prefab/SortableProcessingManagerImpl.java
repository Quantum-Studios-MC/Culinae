...
import quantumstudios.culinae.api.process.CulinaeSortableProcessingRecipeManager;

public final class SortableProcessingManagerImpl<R extends CulinaeProcessingRecipe>
        implements CulinaeSortableProcessingRecipeManager<R>
{
