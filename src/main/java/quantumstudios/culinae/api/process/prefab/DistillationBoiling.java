...
import quantumstudios.culinae.api.process.BasinInteracting.Output;
import quantumstudios.culinae.api.process.Boiling;

public class DistillationBoiling extends AbstractCulinaeProcessingRecipe implements Boiling
{
    ...
    {
        super(new ResourceLocation("Culinae", "distilling_" + input.getFluid().getName()));
        this.input = input;
        this.output = output;
