...
import quantumstudios.culinae.api.process.prefab.ProcessingManagerImpl;
import quantumstudios.culinae.api.process.prefab.SortableProcessingManagerImpl;

public interface CulinaeProcessingRecipeManager<R extends CulinaeProcessingRecipe>
{
    ...
    */
    ...
    static <R extends CulinaeProcessingRecipe> CulinaeProcessingRecipeManager<R> of()
    {
        return new ProcessingManagerImpl<>();
    }

    static <R extends CulinaeProcessingRecipe> CulinaeProcessingRecipeManager<R> of(Comparator<R> comparator)
    {
