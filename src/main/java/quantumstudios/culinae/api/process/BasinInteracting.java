...
public interface BasinInteracting extends CulinaeProcessingRecipe
{
    ...
    static boolean isKnownInput(CulinaeProcessingRecipeManager<BasinInteracting> recipeManager, ItemStack stack)
    {
