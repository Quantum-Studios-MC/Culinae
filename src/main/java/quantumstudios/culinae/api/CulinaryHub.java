...
import quantumstudios.culinae.api.prefab.SimpleCulinarySkillImpl;

import java.util.Objects;

/**
 * The core class of Culinae API that holds the main API interface reference.
 *
 * Culinae API 的核心类，持有主 API 接口的引用。
 */
public final class CulinaryHub
{
    /**
     * The singleton reference of {@link CulinaeAPI}, which will be available
     * after FML pre-initialization stage.
     */
    public static CulinaeAPI API_INSTANCE;
