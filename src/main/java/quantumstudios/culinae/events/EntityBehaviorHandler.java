...
public final class EntityBehaviorHandler
{
    ...
    {
        return entity != null && !entity.isEntityUndead() && entity.getActivePotionEffect(CulinaeRegistry.DISPERSAL) != null;
    }
    ...
    {
        PotionEffect effect = shooter.getActivePotionEffect(CulinaeRegistry.HOT);
        if (effect != null)
        {
