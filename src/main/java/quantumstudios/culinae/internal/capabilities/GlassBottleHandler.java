...
public class GlassBottleHandler
{
    ...
    public static void onAttachCapability(AttachCapabilitiesEvent<ItemStack> event)
    {
        ...
        {
            ResourceLocation resourceLocation = new ResourceLocation(culinae.MODID, "fluid_container");
            GlassBottleWrapper fluidHandler = new GlassBottleWrapper(stack);
            event.addCapability(resourceLocation, fluidHandler);
        }
        else if (CulinaeConfig.GENERAL.attachWaterBottleCapability && stack.getItem() == Items.POTIONITEM)
        {
            ResourceLocation resourceLocation = new ResourceLocation(culinae.MODID, "fluid_container");
    ...
    public static class GlassBottleWrapper extends FluidHandlerItemStackSimple
    {
        ...
        {
            return fluid.getFluid() == FluidRegistry.WATER || fluid.getFluid() == CulinaeFluids.JUICE || fluid.getFluid().getName().equals("milk");
        }
        ...
        protected void setFluid(FluidStack fluid)
        {
            ...
            {
                container = new ItemStack(CulinaeRegistry.BOTTLE);
