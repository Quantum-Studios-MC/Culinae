...
public final class CulinaeFakePlayer
{
    /*
     ...
     */
    private static final GameProfile CULINAE_FAKE_PLAYER_PROFILE = new GameProfile(UUID.fromString("94366666-e5fa-46b2-c69e-f6c9e659454e"), "[Culinae]");
    ...
    public static FakePlayer getInstance(WorldServer world)
    {
        ...
        {
            fakePlayerHolder = new WeakReference<>((instance = FakePlayerFactory.get(world, CULINAE_FAKE_PLAYER_PROFILE)));
        }
