...
import quantumstudios.culinae.api.HeatHandler;
import quantumstudios.culinae.tiles.FuelHeatHandler;
import quantumstudios.culinae.tiles.TileJar;
...
public class PacketCustomEvent implements PacketMod
{
    ...
    public void handleClient(EntityPlayerSP player)
    {
        ...
        default:
        {
            culinae.logger.warn("Undefined event: {} {}, {}, {} {}. Skipping", event, posX, posY, posZ, extraData);
            break;
        }
        }
    }
