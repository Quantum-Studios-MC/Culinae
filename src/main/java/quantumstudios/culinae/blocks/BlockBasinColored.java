...
public class BlockBasinColored extends BlockBasin
{
    ...
    public void mapModel()
    {
        ...
        {
            ModelLoader.setCustomModelResourceLocation(item, i, new ModelResourceLocation(new ResourceLocation(culinae.MODID, "earthen_basin_colored"), "color=" + values[i].getDyeColorName()));
        }
    }
    ...
    {
        return "tile." + culinae.MODID + ".earthen_basin";
    }
