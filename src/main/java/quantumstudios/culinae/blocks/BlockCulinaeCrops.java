...
public class BlockCulinaeCrops extends BlockMod implements IGrowable, IPlantable
{
    ...
    public BlockCulinaeCrops(String name, ItemDefinition crop)
    {
        this(name, crop, crop);
    }

    public BlockCulinaeCrops(String name, ItemDefinition crop, ItemDefinition seed)
    {
        this(name, EnumPlantType.Crop, crop, seed);
    }

    public BlockCulinaeCrops(String name, EnumPlantType plantType, ItemDefinition crop)
    {
        this(name, plantType, crop, crop);
    }

    public BlockCulinaeCrops(String name, EnumPlantType plantType, ItemDefinition crop, ItemDefinition seed)
    {
