...
public class BlockBamboo extends BlockMod
{
    ...
    public void onPlayerRightClickBlock(PlayerInteractEvent.RightClickBlock event)
    {
        if (event.getHand() == EnumHand.MAIN_HAND && event.getItemStack().getItem() == Item.getItemFromBlock(this))
        {
            ...
            if (stack.getItem() instanceof ItemSeeds || (stack.getItem() == Items.DYE && stack.getMetadata() == 3) || (stack.getItem() == CulinaeRegistry.CROPS && (stack.getMetadata() == ItemCrops.Variant.SOYBEAN.getMeta() || stack.getMetadata() == ItemCrops.Variant.PEANUT.getMeta())))
            {
    ...
    public void onPlayerRightClickItem(PlayerInteractEvent.RightClickItem event)
    {
        if (event.getHand() == EnumHand.MAIN_HAND && event.getItemStack().getItem() == Item.getItemFromBlock(this))
        {
            ...
            if (stack.getItem() instanceof ItemSeeds || (stack.getItem() == Items.DYE && stack.getMetadata() == 3) || (stack.getItem() == CulinaeRegistry.CROPS && (stack.getMetadata() == ItemCrops.Variant.SOYBEAN.getMeta() || stack.getMetadata() == ItemCrops.Variant.PEANUT.getMeta())))
            {
                ...
                player.getCooldownTracker().setCooldown(Item.getItemFromBlock(CulinaeRegistry.BAMBOO), 20);
