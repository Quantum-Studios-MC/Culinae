...
import quantumstudios.culinae.tiles.TileMortar;
...
public class BlockMortar extends BlockModHorizontal
{
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
    {
        ...
        if (te instanceof TileMortar)
        {
            ...
            {
                if (heldItem.getItem() != CulinaeRegistry.ITEM_MORTAR)
                {
    ...
    {
        return CulinaeRegistry.ITEM_MORTAR.getItemStack(ItemMortar.Variant.EMPTY);
    }

    @Override
    public Item getItemDropped(IBlockState state, Random rand, int fortune)
    {
        return CulinaeRegistry.ITEM_MORTAR;
    }
