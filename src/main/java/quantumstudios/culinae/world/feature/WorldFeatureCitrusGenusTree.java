...
public class WorldFeatureCitrusGenusTree extends WorldGenAbstractTree
{
    ...
    public boolean generate(World worldIn, Random rand, BlockPos position)
    {
        ...
        else
        {
            ...
            if (state.getBlock().canSustainPlant(state, worldIn, position.down(), net.minecraft.util.EnumFacing.UP, CulinaeRegistry.SAPLING) && position.getY() < worldIn.getHeight() - i - 1)
            {
                IBlockState wood = CulinaeRegistry.LOG.getDefaultState();
    ...
    private static IBlockState getLeavesFromType(BlockModSapling.Type type)
    {
        ...
        {
        case CITRON:
            return CulinaeRegistry.LEAVES_CITRON.getDefaultState();
        case GRAPEFRUIT:
            return CulinaeRegistry.LEAVES_GRAPEFRUIT.getDefaultState();
        case LEMON:
            return CulinaeRegistry.LEAVES_LEMON.getDefaultState();
        case LIME:
            return CulinaeRegistry.LEAVES_LIME.getDefaultState();
        case MANDARIN:
            return CulinaeRegistry.LEAVES_MANDARIN.getDefaultState();
        case ORANGE:
            return CulinaeRegistry.LEAVES_ORANGE.getDefaultState();
        default:
            return CulinaeRegistry.LEAVES_POMELO.getDefaultState();
        }
    }
}
