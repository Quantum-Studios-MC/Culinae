...
public class RecipeChoppingBoardWrapper implements IShapedCraftingRecipeWrapper
{
    ...
    private static final List<ItemStack> Knife = Collections.singletonList(showKnife ? new ItemStack(CulinaeRegistry.KITCHEN_KNIFE) : ItemStack.EMPTY);
    ...
    public void getIngredients(IIngredients ingredients)
    {
        ...
        ingredients.setOutput(VanillaTypes.ITEM, CulinaeRegistry.CHOPPING_BOARD.getItemStack(cover));
    }
