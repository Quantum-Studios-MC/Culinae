...
{
    static final String UID = culinae.MODID + ".vessel";
    ...
    {
        background = guiHelper.createDrawable(new ResourceLocation(culinae.MODID, "textures/gui/jei.png"), 36, 0, 130, 18);
        localizedName = I18n.format(CulinaeRegistry.JAR.getTranslationKey() + ".name");
    }
