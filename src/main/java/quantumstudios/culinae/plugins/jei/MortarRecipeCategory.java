...
{
    static final String UID = culinae.MODID + ".mortar";
    ...
    {
        background = guiHelper.createDrawable(JEICompat.CULINAE_RECIPE_GUI, 0, 0, 148, 18);
        localizedName = I18n.format(CulinaeRegistry.MORTAR.getTranslationKey() + ".name");
    }
