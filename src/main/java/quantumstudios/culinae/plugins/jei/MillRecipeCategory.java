...
{
    public static final String UID = culinae.MODID + '.' + "mill";
    ...
    {
        background = helper.createDrawable(new ResourceLocation(culinae.MODID, "textures/gui/jei.png"), 54, 0, 112, 18);
        localizedName = I18n.format(CulinaeRegistry.MILL.getTranslationKey() + ".name");
    }
