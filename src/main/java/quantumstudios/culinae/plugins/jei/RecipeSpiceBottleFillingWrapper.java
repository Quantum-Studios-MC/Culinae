...
{
    private static final ItemStack bottle = new ItemStack(CulinaeRegistry.SPICE_BOTTLE);
    ...
    public void getIngredients(IIngredients ingredients)
    {
        ...
        if (!inputs.isEmpty())
        {
            ...
            ItemStack output = new ItemStack(CulinaeRegistry.SPICE_BOTTLE);
            CulinaeRegistry.SPICE_BOTTLE.getItemHandler(output).insertItem(0, inputs.get(0), false);
