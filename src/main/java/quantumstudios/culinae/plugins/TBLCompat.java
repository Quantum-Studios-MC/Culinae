...
@KiwiModule(modid = culinae.MODID, name = TBLCompat.MODID, dependency = TBLCompat.MODID, optional = true)
public class TBLCompat implements IModule
{
    ...
    public void init()
    {
        ...
        {
            int amount = CulinaeConfig.GENERAL.axeChoppingPlanksOutput;
            ...
            {
                Processing.CHOPPING.add(new Chopping(new ResourceLocation(MODID, "weedwood_stick"), ItemDefinition.of(planks), new ItemStack(material, CulinaeConfig.GENERAL.axeChoppingStickOutput, 20)));
            }
