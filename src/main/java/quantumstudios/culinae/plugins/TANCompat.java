...
@KiwiModule(modid = culinae.MODID, name = "toughasnails", dependency = "toughasnails", optional = true)
public class TANCompat implements IModule
{
    ...
    public void onItemUseFinish(LivingEntityUseItemEvent.Finish event)
    {
        ...
        if (event.getItem().getItem() == CulinaeRegistry.BOTTLE && enableThirst() && event.getEntityLiving().hasCapability(TANCapabilities.THIRST, null))
        {
