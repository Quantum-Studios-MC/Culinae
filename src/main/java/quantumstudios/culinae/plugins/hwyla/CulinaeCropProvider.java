...
final class CulinaeCropProvider implements IWailaDataProvider
{
    ...
    public List<String> getWailaBody(ItemStack itemStack, List<String> tooltip, IWailaDataAccessor accessor, IWailaConfigHandler config)
    {
        if (config.getConfig(HWYLACompatibility.KEY_SHOW_CROP_MATURITY))
        {
            ...
            if (accessor.getBlock() instanceof BlockCulinaeCrops)
            {
                BlockCulinaeCrops cropBlock = (BlockCulinaeCrops) accessor.getBlock();
