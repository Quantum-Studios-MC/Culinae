...
@ZenClass("mods.culinae.AxeChopping")
@ZenRegister
public class CTAxeChopping
{
    ...
    private static CulinaeProcessingRecipeManager<Chopping> getManager()
    {
    ...
    {
        return CulinaeConfig.GENERAL.axeChopping;
    }

    @ZenMethod
    public static int getDefaultPlanksOutput()
    {
        return CulinaeConfig.GENERAL.axeChoppingPlanksOutput;
    }

    @ZenMethod
    public static int getDefaultStickOutput()
    {
        return CulinaeConfig.GENERAL.axeChoppingStickOutput;
    }
    ...
    private static final class ItemBasedAddition implements IAction
    {
        ...
        {
            return String.format("Add Culinae Axe-Chopping recipe: input %s -> output %s", input, output);
        }
    }
    ...
    private static final class ItemBasedRemoval implements IAction
    {
        ...
        public String describe()
        {
            return String.format("Remove all Culinae Axe-Chopping recipes that has input of %s", input);
        }
    }
