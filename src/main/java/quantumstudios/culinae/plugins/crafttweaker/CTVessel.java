...
public class CTVessel
{
    ...
    private static CulinaeProcessingRecipeManager<Vessel> getManager()
    {
    ...
    private static final class Addition extends CTSupport.Addition
    {
        ...
        {
            return String.format("Add Culinae Vessel recipe: %s + %s + %s -> %s + %s", actualInput, actualInputFluid, actualExtra, actualOutput, actualOutputFluid);
        }
    }
    ...
    private static final class Removal implements IAction
    {
        ...
        public String describe()
        {
            return String.format("Remove all Culinae Vessel recipes that has input of %s, %s and %s", actualInput, actualInputFluid, actualExtra);
        }
    }
