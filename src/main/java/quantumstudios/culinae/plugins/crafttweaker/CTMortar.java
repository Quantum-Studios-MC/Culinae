...
public class CTMortar
{
    ...
    private static CulinaeProcessingRecipeManager<Grinding> getManager()
    {
    ...
    private static final class Addition extends CTSupport.Addition implements IAction
    {
        ...
        {
            return String.format("Add Culinae Mortar recipe: %s -> %s", inputs, output);
        }
    }
    ...
    private static final class Removal implements IAction
    {
        ...
        public String describe()
        {
            return String.format("Remove Culinae Mortar recipe that has input of %s", inputs);
        }
    }
