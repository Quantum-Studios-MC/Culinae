...
import quantumstudios.culinae.plugins.jei.JEICompat;

@Config(modid = culinae.MODID, name = culinae.MODID, category = "")
@Mod.EventBusSubscriber(modid = culinae.MODID)
public final class CulinaeConfig
{

    private CulinaeConfig()
    {
    ...
    {
        if (event.getModID().equals(culinae.MODID))
        {
            ConfigManager.sync(culinae.MODID, Config.Type.INSTANCE);
    ...
    @Config.Comment("General settings of culinae.")
    @Config.LangKey("culinae.config.general")
    @Config.Name("General")
    ...
    public static final class General
    {
        ...
        @Config.LangKey("culinae.config.general.auto_recipe_unlocking")
        @Config.Name("AutoRecipeUnlocking")
        public boolean autoRecipeUnlocking = true;

        @Config.Comment("Give player the manual of Culinae Mod when they firstly spawn in world.")
        @Config.LangKey("culinae.config.general.spawn_book")
        @Config.Name("SpawnBook")
        @Config.RequiresMcRestart
        public boolean spawnBook = true;

        @Config.LangKey("culinae.config.general.fruit_growing_speed")
        @Config.Name("FruitGrowingSpeed")
        @Config.RangeInt(min = 0, max = 100)
        public int fruitGrowingSpeed = 10;

        @Config.LangKey("culinae.config.general.fruit_drops")
        ...
        @Config.LangKey("culinae.config.general.bamboo_blowpipe")
        ...
        @Config.LangKey("culinae.config.progression.axe_chopping")
        ...
        @Config.LangKey("culinae.config.general.mill_work_cycle")
        ...
        @Config.LangKey("culinae.config.general.basin_heating_in_daylight")
    ...
    @Config.Comment("Config options of Culinae Hardcore Module.")
    @Config.LangKey("culinae.config.hardcore")
    ...
    public static final class Hardcore
    {
        ...
        @Config.LangKey("culinae.config.hardcore.enable")
        @Config.Name("Enable")
        @Config.RequiresMcRestart
        public boolean enable = true;

        @Config.Comment("If true, bread will require mill to make.")
        @Config.LangKey("culinae.config.hardcore.bread")
        ...
        @Config.LangKey("culinae.config.hardcore.cookie")
        ...
        @Config.LangKey("culinae.config.hardcore.sugar")
        ...
        @Config.LangKey("culinae.config.hardcore.food_level_lose")
        ...
        @Config.LangKey("culinae.config.hardcore.food_level_retain_ratio")
        ...
        @Config.LangKey("culinae.config.hardcore.food_level_lose_blacklist")
        ...
        @Config.LangKey("culinae.config.general.skill_lose_on_death")
        ...
        @Config.LangKey("culinae.config.general.skill_retain_ratio")
    ...
    @Config.LangKey("culinae.config.world_gen")
    ...
    public static final class WorldGen
    {
        ...
        @Config.LangKey("culinae.config.general.fruit_trees_gen_rate")
        ...
        @Config.LangKey("culinae.config.general.bamboos_gen_rate")
        ...
        @Config.LangKey("culinae.config.general.crops_gen_rate")
    ...
    public static final class Client
    {
        ...
        @Config.LangKey("culinae.config.progression.axe_list")
        @Config.Name("AxeList")
        ...
        @Config.LangKey("culinae.config.general.always_render_drinkro")
        ...
        @Config.Comment("List of items that, when functions as chopping board base, will attempt to find the correct block model when the board is rendered. " +
                "See https://github.com/Snownee/Culinae/issues/80 for more details.")
        @Config.LangKey("culinae.config.progression.block_model_for_chopping_board")
