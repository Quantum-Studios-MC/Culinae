...
public class CulinaeFluids
{
    ...
    static
    {
        ...
        SOY_SAUCE = new Fluid("soy_sauce", new ResourceLocation(culinae.MODID, "block/soy_sauce_still"), new ResourceLocation(culinae.MODID, "block/soy_sauce_flow"));
        ...
        JUICE = new FluidJuice("Culinae_juice");
    }
