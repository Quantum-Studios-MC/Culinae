...
import quantumstudios.culinae.client.model.IngredientMeshDefinition;
...
import quantumstudios.culinae.internal.food.IngredientFood;
...
public final class ItemIngredient extends ItemFood implements IModItem, CookingVessel
{
    ...
    public void mapModel()
    {
        ...
        ModelBakery.registerItemVariants(this, CulinaeItemRendering.EMPTY_MODEL, new ResourceLocation(culinae.MODID, "cmaterial/cubed"), new ResourceLocation(culinae.MODID, "cmaterial/diced"), new ResourceLocation(culinae.MODID, "cmaterial/minced"), new ResourceLocation(culinae.MODID, "cmaterial/paste"), new ResourceLocation(culinae.MODID, "cmaterial/shredded"), new ResourceLocation(culinae.MODID, "cmaterial/sliced"));
    }
    ...
    public ItemStack onItemUseFinish(ItemStack stack, World worldIn, EntityLivingBase entityLiving)
    {
        ...
        if (stack.getTagCompound() != null && entityLiving instanceof EntityPlayer)
        {
            ...
            ingredient = CulinaePersistenceCenter.deserializeIngredient(stack.getTagCompound());
            if (ingredient != null)
            {
    ...
    public boolean hasEffect(ItemStack stack)
    {
        ...
        Ingredient ingredient = CulinaePersistenceCenter.deserializeIngredient(stack.getTagCompound());
        if (ingredient == null)
        {
            return false;
        }
    ...
    public static ItemStack make(Material material, Form form, int amount, int[] actions)
    {
        ...
        {
            ItemStack stack = new ItemStack(CulinaeRegistry.INGREDIENT, amount);
            Ingredient ingredient = new Ingredient(material, form);
            NBTTagCompound data = CulinaePersistenceCenter.serialize(ingredient);
    ...
    {
        ItemStack itemStack = new ItemStack(CulinaeRegistry.INGREDIENT);
        itemStack.setTagCompound(CulinaePersistenceCenter.serialize(ingredient));
        if (ingredient.getEffects().contains(CulinaryHub.CommonEffects.RARE))
        {
            NBTHelper.of(itemStack).setBoolean(CulinaeSharedSecrets.KEY_RARE, true);
        }
        return itemStack;
    }
    ...
    public static int[] getActions(ItemStack stack)
    {
        ...
        {
            if (stack.getItem() == CulinaeRegistry.INGREDIENT)
            {
                culinae.logger.warn("Found invalid ItemIngredient: {}", stack);
            }
            return new int[2];
        }
    ...
    {
        return NBTHelper.of(stack).getBoolean(CulinaeSharedSecrets.KEY_RARE) ? EnumRarity.UNCOMMON : EnumRarity.COMMON;
    }
