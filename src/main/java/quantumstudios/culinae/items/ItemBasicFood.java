...
public class ItemBasicFood<T, E extends IVariant<T> & IRarityGetter> extends ItemFood implements IModItem
{
    ...
    {
        return stack.getItem() == CulinaeRegistry.BASIC_FOOD && stack.getMetadata() == Variant.EMPOWERED_CITRON.getMeta();
    }

    @Override
    public boolean onDroppedByPlayer(ItemStack stack, EntityPlayer player)
    {
        if (stack.getItem() == CulinaeRegistry.BASIC_FOOD && stack.getMetadata() == Variant.EMPOWERED_CITRON.getMeta())
        {
