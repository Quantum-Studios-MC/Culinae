...
import quantumstudios.culinae.internal.capabilities.DrinkContainer;
...
public class ItemDrink extends ItemAbstractComposite
{
    ...
    public void mapModel()
    {
        ...
        ModelBakery.registerItemVariants(this, CulinaeItemRendering.EMPTY_MODEL, new ResourceLocation(culinae.MODID, "dish/drink"), new ResourceLocation(culinae.MODID, "dish/smoothie"), new ResourceLocation(culinae.MODID, "dish/gelo"), new ResourceLocation(culinae.MODID, "dish/soda"));
    }
